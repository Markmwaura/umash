...
Route::get('erpReports/sales', 'ErpReportsController@sales');
Route::get('erpReports/purchases', 'ErpReportsController@purchases');
...
Route::get('purchaseorders', function(){
  ...
  return View::make('erppurchases.index', compact('items', 'locations', 'orders'));
});
...
Route::get('quotationorders', function(){
  ...
  return View::make('erpquotations.index', compact('items', 'locations', 'orders'));
});
...
Route::get('erpquotation/commit', function(){
