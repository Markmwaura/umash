...
<br>
<table width="600">
        <tr><td colspan='8'>{{ $erporder->client->name.","}}</td><td width="40">Quote#:</td><td width="100">{{ $erporder->order_number."."}}</td></tr>
...
<div class="footer">
   ...
   <td align="right"><strong>{{ asMoney($amount)}}</strong></td></tr>
   <?php $i++; ?>
    @endforeach
