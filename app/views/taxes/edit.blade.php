  ...
  <div class="col-lg-5">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <input class="form-control" placeholder="" type="text" name="name" id="name" value="{{$tax->name}}">
        </div>

        <div class="form-group">
            <label for="username">Rate (% e.g. 5):</label>
            <input class="form-control" placeholder="" type="text" name="rate" id="rate" value="{{$tax->rate}}">
        </div>
