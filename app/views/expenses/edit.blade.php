...
<div class="row">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <input class="form-control" placeholder="" type="text" name="amount" id="amount" value="{{$expense->amount}}">
        </div>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                        ...
                        <input class="form-control datepicker"  readonly="readonly" placeholder="" type="text" name="date" id="date" value="{{$expense->date}}">
                        </div>
          </div>
